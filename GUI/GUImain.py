"""
This GUI needs writing to include the functionality of MeterReadings

Updated on 12/08/2023 - R.White

Needs fixing to:
- fix the load in button
- integrate a plot within the gUI - plot button
- integrate a process_data function button within the GUI
- Visualise the electricity, gas and cost
